...
public class MainActivity extends AppCompatActivity {
    ...
    public class GithubQueryTask extends AsyncTask<URL, Void, String> {
        ...
        protected String doInBackground(URL... urls) {
            ...
            String githubSearchQueryResults = null;
            try {
                githubSearchQueryResults = NetworkUtils.getResponseFromHttpUrl(searchUrl);
            } catch (IOException e){
                e.printStackTrace();
            }
            return githubSearchQueryResults;
        }
...
//            mSearchResultsTextView.setText("Hayoooo");
        }
    }
    @Override

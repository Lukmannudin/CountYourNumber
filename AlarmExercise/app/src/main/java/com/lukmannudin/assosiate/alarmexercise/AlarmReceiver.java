...
public class AlarmReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        int notifId = Integer.valueOf(type);
...
//        showToast(context, title, message);
        ...
        showAlarmNotification(context, "Catalogue Movie",
                "Catalogue Movie missing you!", notifId);
    ...
    public void setOneTimeAlarm(Context context, String type, String date, String time, String message) {
        ...
        if (alarmManager != null) {
            Log.i("cekoprat1",String.valueOf(calendar.getTime()));
